...
import com.fisco.app.contract.ReceivableWithOverdue;
...
public class ContractService {
     ...
     * @return 交易哈希
     */
    public String recordCreditLimitOnChain(com.fisco.app.entity.CreditLimit creditLimit) {
        ...
        try {
            // TODO: 等待使用sol2java工具生成完整的CreditLimit Java包装类后实现
            // 当前先记录日志，模拟上链成功
     ...
     * @return 交易哈希
     */
    public String recordCreditUsageOnChain(com.fisco.app.entity.CreditLimitUsage usage) {
     ...
     * @return 交易哈希
     */
    public String recordCreditAdjustOnChain(com.fisco.app.entity.CreditLimitAdjustRequest adjustRequest) {
     ...
     * @return 交易哈希
     */
    public String updateRiskLevelOnChain(String limitId, com.fisco.app.entity.CreditLimit.RiskLevel riskLevel, String reason) {
