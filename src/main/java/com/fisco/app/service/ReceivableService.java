...
import com.fisco.app.repository.ReceivableRepository;
...
public class ReceivableService {
     ...
     */
    @Transactional
    public com.fisco.app.dto.ReceivableSplitResponse splitReceivable(
            @NonNull @Valid com.fisco.app.dto.ReceivableSplitRequest request, @NonNull String applicantId) {
        log.info("==================== 应收账款拆分开始 ====================");
        ...
        try {
            ...
            if (request.getSplitScheme() == com.fisco.app.dto.ReceivableSplitRequest.SplitScheme.EQUAL) {
                // 等额拆分
                ...
                for (com.fisco.app.dto.ReceivableSplitRequest.SplitDetail detail : request.getSplitDetails()) {
            ...
            // 8. 创建响应
            com.fisco.app.dto.ReceivableSplitResponse response = new com.fisco.app.dto.ReceivableSplitResponse();
     ...
     */
    @Transactional
    public com.fisco.app.dto.ReceivableMergeResponse mergeReceivables(
            com.fisco.app.dto.ReceivableMergeRequest request, String applicantId) {
        log.info("==================== 应收账款合并开始 ====================");
        ...
        try {
            ...
            // 7. 创建响应
            com.fisco.app.dto.ReceivableMergeResponse response = new com.fisco.app.dto.ReceivableMergeResponse();
            response.setApplicationId(java.util.UUID.randomUUID().toString());
            response.setStatus("PENDING");
