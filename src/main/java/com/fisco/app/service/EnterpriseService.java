...
import com.fisco.app.entity.EnterpriseAuditLog;
import com.fisco.app.entity.User;
import com.fisco.app.repository.EnterpriseAuditLogRepository;
import com.fisco.app.repository.EnterpriseRepository;
import com.fisco.app.repository.UserRepository;
...
public class EnterpriseService {
     ...
     * @throws com.fisco.app.exception.BusinessException.EnterpriseNotFoundException 如果企业不存在
     */
    public com.fisco.app.dto.EnterpriseWithUsersDTO getEnterpriseWithUsers(String enterpriseId) {
        Enterprise enterprise = enterpriseRepository.findByIdWithUsers(enterpriseId)
                .orElseThrow(() -> new com.fisco.app.exception.BusinessException.EnterpriseNotFoundException(enterpriseId));

        return com.fisco.app.dto.EnterpriseWithUsersDTO.fromEntity(enterprise);
    }
    public com.fisco.app.dto.EnterpriseWithUsersDTO getEnterpriseWithUsersByAddress(String address) {
     ...
     * 根据用户名获取企业及其所有用户
     */
    public com.fisco.app.dto.EnterpriseWithUsersDTO getEnterpriseWithUsersByUsername(String username) {
     ...
     * 获取企业及其用户数量统计
     */
    public com.fisco.app.dto.EnterpriseWithUsersDTO getEnterpriseWithUserCount(String enterpriseId) {
        ...
        java.util.List<com.fisco.app.entity.User> users = userRepository.findByEnterpriseId(enterpriseId);

        return com.fisco.app.dto.EnterpriseWithUsersDTO.fromEntities(enterprise, users);
    }
     ...
     */
    @Transactional
    public com.fisco.app.dto.AuditBatchResult batchApproveEnterprises(
        ...
        com.fisco.app.dto.AuditBatchResult result = new com.fisco.app.dto.AuditBatchResult();
     ...
     */
    @Transactional
    public com.fisco.app.dto.AuditBatchResult batchRejectEnterprises(
