 ...
 * <pre>
 * // 校验当前企业为仓储方
 * @WarehousePermissionCheck(allowedRoles = {9})
 * @PostMapping("/receipt/mint")
 * public Result<?> mintReceipt(...) { ... }
 *
 * // 校验当前企业为金融机构
 * @WarehousePermissionCheck(allowedRoles = {6})
 * @PostMapping("/receipt/lock")
 * public Result<?> lockReceipt(...) { ... }
 *
 * // 校验当前企业为仓储方或金融机构
 * @WarehousePermissionCheck(allowedRoles = {9, 6})
