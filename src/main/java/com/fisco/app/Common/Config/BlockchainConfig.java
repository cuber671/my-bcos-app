...
public class BlockchainConfig {
    ...
    private CryptoKeyPair loadKeyPairFromConfig(CryptoSuite cryptoSuite) throws Exception {
        ...
        // 使用 CryptoSuite 创建 CryptoKeyPair
        // 从私钥获取原始私钥字节并创建 CryptoKeyPair
