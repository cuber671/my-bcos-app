...
import com.fisco.app.service.NotificationService;
...
public class NotificationController {
    ...
    public Result<List<com.fisco.app.entity.NotificationSubscription>> getUserSubscriptions(
            Authentication authentication) {
        log.info("查询用户订阅: userId={}", authentication.getName());

        List<com.fisco.app.entity.NotificationSubscription> subscriptions =
