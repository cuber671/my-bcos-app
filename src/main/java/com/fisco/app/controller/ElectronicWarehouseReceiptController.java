...
import com.fisco.app.service.ElectronicWarehouseReceiptService;
...
public class ElectronicWarehouseReceiptController {
    ...
    public ResponseEntity<ReceiptFreezeResponse> freezeReceipt(
            @Valid @RequestBody com.fisco.app.dto.ReceiptFreezeRequest request,
            @RequestHeader(value = "X-User-Id", required = false) String userId,
            @RequestHeader(value = "X-User-Name", required = false) String userName) {
    ...
    public ResponseEntity<ReceiptUnfreezeResponse> unfreezeReceipt(
            @Valid @RequestBody com.fisco.app.dto.ReceiptUnfreezeRequest request,
            @RequestHeader(value = "X-User-Id", required = false) String userId,
            @RequestHeader(value = "X-User-Name", required = false) String userName) {
