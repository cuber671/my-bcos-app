...
public class ContractStatusController {
    ...
    public Map<String, Object> getBillContractStatus() {
        ...
        try {
            Bill bill = Bill.load(BILL_ADDRESS, client, cryptoKeyPair);
    ...
    public Map<String, Object> getReceivableContractStatus() {
        ...
        try {
            Receivable receivable = Receivable.load(RECEIVABLE_ADDRESS, client, cryptoKeyPair);
    ...
    public Map<String, Object> getWarehouseReceiptContractStatus() {
        ...
        try {
            WarehouseReceipt wr = WarehouseReceipt.load(WAREHOUSE_RECEIPT_ADDRESS, client, cryptoKeyPair);
