...
import com.fisco.app.service.BillService;
...
public class BillController {
    ...
    public Result<Bill> cancelBill(
            @ApiParam(value = "票据ID", required = true) @PathVariable @NonNull String billId,
            @ApiParam(value = "作废请求参数", required = true) @Valid @RequestBody com.fisco.app.dto.CancelBillRequest request,
            Authentication authentication) {
    ...
    public Result<Bill> freezeBill(
            @ApiParam(value = "票据ID", required = true) @PathVariable @NonNull String billId,
            @ApiParam(value = "冻结请求参数", required = true) @Valid @RequestBody com.fisco.app.dto.FreezeBillRequest request,
            Authentication authentication) {
        String operatorAddress = authentication.getName();
    ...
    public Result<Bill> unfreezeBill(
            @ApiParam(value = "票据ID", required = true) @PathVariable @NonNull String billId,
            @ApiParam(value = "解冻请求参数", required = true) @Valid @RequestBody com.fisco.app.dto.UnfreezeBillRequest request,
            Authentication authentication) {
        String operatorAddress = authentication.getName();
    ...
    public Result<com.fisco.app.dto.FinanceApplicationResponse> applyFinance(
            @ApiParam(value = "票据ID", required = true) @PathVariable String billId,
            @ApiParam(value = "融资申请信息", required = true) @RequestBody @Valid com.fisco.app.dto.FinanceBillRequest request,
        ...
        com.fisco.app.dto.FinanceApplicationResponse response = billService.applyFinance(billId, request, applicantAddress);
    ...
    public Result<com.fisco.app.dto.FinanceApplicationResponse> approveFinance(
            @ApiParam(value = "审核信息", required = true) @RequestBody @Valid com.fisco.app.dto.ApproveFinanceRequest request,
        ...
        com.fisco.app.dto.FinanceApplicationResponse response = billService.approveFinance(request, reviewerAddress);
    ...
    public Result<java.util.List<com.fisco.app.dto.FinanceApplicationResponse>> getPendingFinanceApplications(
        ...
        java.util.List<com.fisco.app.dto.FinanceApplicationResponse> responses =
    ...
    @SuppressWarnings("null")
    public Result<com.fisco.app.dto.FinanceApplicationResponse> repayFinance(
            @ApiParam(value = "融资申请ID", required = true) @PathVariable String applicationId,
            @ApiParam(value = "还款信息", required = true) @RequestBody @Valid com.fisco.app.dto.RepayFinanceRequest request,
        ...
        com.fisco.app.dto.FinanceApplicationResponse response = billService.repayFinance(applicationId, request, payerAddress);
