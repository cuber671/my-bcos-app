...
public class Bill {
    ...
    @ApiModelProperty(value = "票据状态",
            notes = "DRAFT-草稿, PENDING_ISSUANCE-待开票, ISSUED-已开票, NORMAL-正常, ENDORSED-已背书, " +
                    "PLEDGED-已质押, DISCOUNTED-已贴现, FINANCED-已融资, FROZEN-已冻结, EXPIRED-已过期, " +
                    "DISHONORED-已拒付, CANCELLED-已作废, PAID-已付款, SETTLED-已结算")
